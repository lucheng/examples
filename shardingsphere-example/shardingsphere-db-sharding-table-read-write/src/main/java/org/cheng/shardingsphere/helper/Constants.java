package org.cheng.shardingsphere.helper;

public class Constants {

	/**
	 * The constant REDIS_GET_COMMAND. This is Hystrix command name for GET command
	 * of redis.
	 */
	public static final String REDIS_GET_COMMAND = "redisClientGet";
	/**
	 * The constant REDIS_SET_COMMAND. This is Hystrix command name for SET command
	 * of redis.
	 */
	public static final String REDIS_SET_COMMAND = "redisClientSet";
	/**
	 * The constant REDIS_DELETE_COMMAND. This is Hystrix command name for DELETE
	 * command of redis.
	 */
	public static final String REDIS_DELETE_COMMAND = "redisClientDelete";

	/**
	 * The constant REDIS_GET_FROM_DB. This is Hystrix command name for HGETALL
	 * command of redis.
	 */
	public static final String REDIS_GET_FROM_DB = "redisGetFromDB";
	/**
	 * The constant REDIS_PUT_IN_DB. This is Hystrix command name for SET command of
	 * redis.
	 */
